...
(function () {
  ...
  const MLK = {
    ...
    Config: {
      AI_TOKEN: "cd03daa134f6416899971f7445011117.4aF3svWYM6uR3Pln",
    ...
    UI: {
      ...
      createHelperBox() {
        ...
        titleBar.style.cssText = `
          ...
          text-align: center;
        `;
        titleBar.textContent = "名录库助手 v4.3";
    ...
    ErrorFixer: {
      ...
      */
      async universalRepair() {
        ...
        // 检查元素是否存在，如果存在则设置第一个选项为选中状态
        if (selectElement) {
          selectElement.selectedIndex = 0; // 0 表示第一个选项
        }
      },
